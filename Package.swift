...
let package = Package(
    ...
    targets: [
        .target(name: "JiuzhouProtocol", path: "Jiuzhou",
                exclude: ["AndroidArt", "Assets.xcassets", "AndroidEntryView.swift", "AndroidWorldView.swift", "AndroidWebPanel.swift", "GameView.swift", "MudRichText.swift", "JiuzhouApp.swift", "parity-scenes.json", "AMRBridge.h", "VoiceCodec.swift", "MudVoice.swift"],
